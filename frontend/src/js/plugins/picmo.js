import { Events as xt, getOptions as vt, createPicker as bt, FocusTrap as Et, animate as Z, createStyleInjector as Ct } from "https://unpkg.com/picmo@^5.7.0?module";
function V(t) {
  return t.split("-")[0];
}
function N(t) {
